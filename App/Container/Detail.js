    ...
    render() {
        return (
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{marginBottom:30,display:'flex',justifyContent:"space-around"}}>
                    <View style={{margin:10,marginLeft:14}}>
                        <View style={{flexDirection:"row"}}>
                    ...
                    <View style={{marginLeft:15,marginTop:10}}>
                        <View style={{flexDirection:"row"}}>
                            ...
                            <Text style={{fontSize:18,marginLeft:28}}>Disyar'i kan dari</Text>
                        </View>
                        <Text style={{marginLeft:45,color:'#545454',}}>Qashash al-Anbiya' Ibn Katsir, Badai' az-Zuhur Imam as-Suyuthi dan selainnya</Text>
                    </View>
                </View>
            </ScrollView>
        )
